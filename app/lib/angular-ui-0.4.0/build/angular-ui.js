...
angular.module('ui.directives').directive('uiFormInput', function() {
    ...
    var isIgnoredAttr = function(atr) {
        var ignoredAttrs = ["uiFormInput", "class", "type", "ngRepeat", "ngModel", "uiRequired"];
	...
	return {
		...
		compile: function(element, attrs) {
            ...
            var classes = "ui-form-input-" + type + (attrs['class'] ? " " + attrs['class'] : "");
            var requiredHtml = attrs.$attr['uiRequired'] ? "required" + (attrs['uiRequired'] ? "=\"" + attrs['uiRequired'] + "\"" : "") : "";
            ...
            return function(scope, elem, attr, ctrl) {
                if (type == "multicheckbox") {
                    ...
                    for (var i = 0; i < scope.ngModel.length; i++) {
                        ...
                        if (scope.checked >= scope.uiRequired) {
