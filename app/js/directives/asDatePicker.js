...
/*sample usage
 ...
 <div class="control-group input-append">
     <input type="text" ng-model="datepicker.date" data-date-format="dd/mm/yyyy" as-date-picker>
     <button type="button" class="btn" data-toggle="datepicker"><i class="icon-calendar"></i></button>
 </div>
 */

angular.module('myApp.directives')
    .directive('asDatePicker', ['$timeout', /*'$strap.config',*/ function($timeout, config) {
        ...
        return {
            ...
            link: function postLink(scope, element, attrs, controller) {
                ...
                //options temporarily removed because no current functionality included
                //var options = config.datepicker || {},
                var language = attrs.language || 'en',
                    type = attrs.dateType || 'date',
                    format = attrs.dateFormat ||  ($.fn.datepicker.dates[language] && $.fn.datepicker.dates[language].format) || 'yyyy-mm-dd';
